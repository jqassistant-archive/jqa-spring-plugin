...
public class LayerDependenciesIT extends AbstractJavaPluginIT {
    ...
    public void virtualComponentDependencies() throws Exception {
        ...
        store.beginTransaction();
        assertThat(query("MATCH (r:Spring:Controller)-[:DEPENDS_ON]->(s:Spring:Repository) RETURN r").getColumn("r"), hasItem(typeDescriptor(ControllerWithRepositorInterface.class)));
        store.commitTransaction();
    }
